<%-- 
    Document   : FormActividades
    Created on : 12-05-2018, 12:18:21 AM
    Author     : jufer
--%>
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <h4 class="display-4">Ingresar actividades</h4>
                <a href="#menu-toggle" class="btn btn-secondary" id="menu-toggle">Desplegar menu</a>
                <div class="formulario">
                    <form method="POST" action="">
                        <div class="form-group">
                            <label for="codigo-actividad">Codigo de la actividad</label>
                            <input type="text" class="form-control" name="codigo-actividad" placeholder="Codigo actividad">
                        </div>
                        <div class="form-group">
                            <label for="nombre-actividad">Nombre de la actividad</label>
                            <input type="text" class="form-control" name="nombre-actividad" placeholder="Nombre actividad">
                        </div>
                        <div class="form-group">
                            <label for="tiempo-estimado">Tiempo estimado</label>
                            <input type="text" class="form-control" name="tiempo-estimado" placeholder="Tiempo estimado">
                        </div>  
