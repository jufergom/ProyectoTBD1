<%-- 
    ...
    Created on : 12-14-2018, 01:40:37 AM
    Author     : jufer
--%>
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <h4 class="display-4">Nueva orden</h4>
                <a href="#menu-toggle" class="btn btn-secondary" id="menu-toggle">Desplegar menu</a>
                <div class="formulario">
                    <form method="POST" action="InsertOrden">
                        <div class="form-group">
                            <label for="codigo-orden">Codigo de orden</label>
                            <input type="text" class="form-control" name="codigo-orden" placeholder="DO-####">
                        </div>
                        <div class="form-group">
                            <label for="nombre-proyecto">Nombre del proyecto</label>
                            <input type="text" class="form-control" name="nombre-proyecto" placeholder="Nombre del proyecto a solicitar">
                        </div>
                        <div class="form-group">
                            <label for="cliente-solicitante">Cliente solicitante</label>
                            <select name="cliente-solicitante" id="cliente-solicitante" class="form-control form-control-lg">
                                <!--Colocar los id de los empleados con un ciclo-->
                                <%
                                    Conexion c = new Conexion();
                                    c.prenderConexion();
                                    ResultSet rs = c.getQueryResult("SELECT Nombre, Codigo FROM Clientes");
                                    while(rs.next()) {
                                        out.println("<option value=\""+rs.getString("Codigo")+"\">"+rs.getString("Nombre")+"</option>");
                                    }
                                    c.apagarConexion();
                                %>
                            </select>
